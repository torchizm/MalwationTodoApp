        ...
        <main style={{ flexDirection: 'column' }} className='content-container'>
            <div className='content-actions'>
                <p className='text-clamp' style={{ fontWeight: '500', flexGrow: '1' }}>
                    <Link className='breadcrumb' to="/admin/dashboard">Yönetici Paneli</Link> / <Link className='breadcrumb' to="/admin/workspaces">Çalışma Alanları</Link> / {workspace.name}
                </p>
            ...
            <div className='content-wrapper'>
                {workspace.participants &&
                    <div className='workspace-user-list'>
                        ...
                        {workspace._id &&
                        <Link style={{ width: '100%', marginTop: '2rem' }} to={`/admin/workspace/${workspace._id}/addmember`}>
